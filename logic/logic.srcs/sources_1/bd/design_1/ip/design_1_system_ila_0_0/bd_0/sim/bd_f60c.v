...
module bd_f60c
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_1_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_1_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN design_1_zynq_ps_0_FCLK_CLK0, DATA_WIDTH 32, FREQ_HZ 200000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 12, INSERT_VIP 0, MAX_BURST_LENGTH 16, NUM_READ_OUTSTANDING 8, NUM_READ_THREADS 4, NUM_WRITE_OUTSTANDING 8, NUM_WRITE_THREADS 4, PHASE 0.000, PROTOCOL AXI3, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [31:0]SLOT_1_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_2_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_2_AXI, ADDR_WIDTH 10, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN design_1_zynq_ps_0_FCLK_CLK0, DATA_WIDTH 32, FREQ_HZ 200000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 8, NUM_READ_THREADS 4, NUM_WRITE_OUTSTANDING 8, NUM_WRITE_THREADS 4, PHASE 0.000, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [9:0]SLOT_2_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI:SLOT_1_AXI:SLOT_2_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_zynq_ps_0_FCLK_CLK0, FREQ_HZ 200000000, INSERT_VIP 0, PHASE 0.000" *) input clk;
  input [31:0]probe0;
  ...
  bd_f60c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe49(net_slot_1_axi_awcache),
        .probe5(net_slot_0_axi_arid),
        .probe50(net_slot_1_axi_awid),
        .probe51(net_slot_1_axi_awlen),
        .probe52(net_slot_1_axi_awlock),
        .probe53(net_slot_1_axi_awprot),
        .probe54(net_slot_1_axi_awqos),
        .probe55(net_slot_1_axi_awsize),
        .probe56(net_slot_1_axi_b_cnt),
        .probe57(net_slot_1_axi_bid),
        .probe58(net_slot_1_axi_bresp),
        .probe59(net_slot_1_axi_r_cnt),
        .probe6(net_slot_0_axi_arlen),
        .probe60(net_slot_1_axi_rdata),
        .probe61(net_slot_1_axi_rid),
        .probe62(net_slot_1_axi_rresp),
        .probe63(net_slot_1_axi_wdata),
        .probe64(net_slot_1_axi_wid),
        ...
        .probe73(net_slot_2_axi_arprot),
        .probe74(net_slot_2_axi_aw_cnt),
        .probe75(net_slot_2_axi_awaddr),
        .probe76(net_slot_2_axi_awprot),
        .probe77(net_slot_2_axi_b_cnt),
        .probe78(net_slot_2_axi_bresp),
        .probe79(net_slot_2_axi_r_cnt),
        .probe8(net_slot_0_axi_arprot),
        .probe80(net_slot_2_axi_rdata),
        .probe81(net_slot_2_axi_rresp),
        .probe82(net_slot_2_axi_wdata),
        .probe83(net_slot_2_axi_wstrb),
        .probe84(net_slot_2_axi_aw_ctrl),
        .probe85(net_slot_2_axi_w_ctrl),
        .probe86(net_slot_2_axi_b_ctrl),
        .probe87(net_slot_2_axi_ar_ctrl),
        .probe88(net_slot_2_axi_r_ctrl),
