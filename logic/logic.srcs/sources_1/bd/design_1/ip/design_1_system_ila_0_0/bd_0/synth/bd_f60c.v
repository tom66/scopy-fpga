...
module bd_f60c
  ...
  bd_f60c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe21(net_slot_1_axi_arburst),
        .probe22(net_slot_1_axi_arcache),
        .probe23(net_slot_1_axi_arid),
        .probe24(net_slot_1_axi_arlen),
        .probe25(net_slot_1_axi_arlock),
        .probe26(net_slot_1_axi_arprot),
        .probe27(net_slot_1_axi_arqos),
        .probe28(net_slot_1_axi_arsize),
        .probe29(net_slot_1_axi_aw_cnt),
        .probe3(net_slot_0_axi_arsize),
        .probe30(net_slot_1_axi_awaddr),
        .probe31(net_slot_1_axi_awburst),
        .probe32(net_slot_1_axi_awcache),
        .probe33(net_slot_1_axi_awid),
        .probe34(net_slot_1_axi_awlen),
        .probe35(net_slot_1_axi_awlock),
        .probe36(net_slot_1_axi_awprot),
        .probe37(net_slot_1_axi_awqos),
        .probe38(net_slot_1_axi_awsize),
        .probe39(net_slot_1_axi_b_cnt),
        .probe4(net_slot_0_axi_aw_cnt),
        .probe40(net_slot_1_axi_bid),
        .probe41(net_slot_1_axi_bresp),
        .probe42(net_slot_1_axi_r_cnt),
        .probe43(net_slot_1_axi_rdata),
        .probe44(net_slot_1_axi_rid),
        .probe45(net_slot_1_axi_rresp),
        .probe46(net_slot_1_axi_wdata),
        .probe47(net_slot_1_axi_wid),
