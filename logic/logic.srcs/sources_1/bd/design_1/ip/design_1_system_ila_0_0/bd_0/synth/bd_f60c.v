...
module bd_f60c
   (SLOT_0_AXI_araddr,
    ...
    probe9,
    resetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_0_AXI, ADDR_WIDTH 10, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN design_1_processing_system7_0_1_FCLK_CLK0, DATA_WIDTH 32, FREQ_HZ 177777771, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 8, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 8, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [9:0]SLOT_0_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_processing_system7_0_1_FCLK_CLK0, FREQ_HZ 177777771, INSERT_VIP 0, PHASE 0.000" *) input clk;
  input [5:0]probe0;
  input [0:0]probe1;
  input [0:0]probe10;
  input [15:0]probe11;
  ...
  bd_f60c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe30(probe30_1),
        .probe31(probe31_1),
        .probe32(net_slot_0_axi_ar_cnt),
        .probe33(net_slot_0_axi_araddr),
        .probe34(net_slot_0_axi_arprot),
        .probe35(net_slot_0_axi_aw_cnt),
        .probe36(net_slot_0_axi_awaddr),
        .probe37(net_slot_0_axi_awprot),
        .probe38(net_slot_0_axi_b_cnt),
        .probe39(net_slot_0_axi_bresp),
        .probe4(probe4_1),
        .probe40(net_slot_0_axi_r_cnt),
        .probe41(net_slot_0_axi_rdata),
        .probe42(net_slot_0_axi_rresp),
        .probe43(net_slot_0_axi_wdata),
        .probe44(net_slot_0_axi_wstrb),
        .probe45(net_slot_0_axi_aw_ctrl),
        .probe46(net_slot_0_axi_w_ctrl),
        .probe47(net_slot_0_axi_b_ctrl),
        .probe48(net_slot_0_axi_ar_ctrl),
        .probe49(net_slot_0_axi_r_ctrl),
        .probe5(probe5_1),
        .probe6(probe6_1),
        .probe7(probe7_1),
        .probe8(probe8_1),
