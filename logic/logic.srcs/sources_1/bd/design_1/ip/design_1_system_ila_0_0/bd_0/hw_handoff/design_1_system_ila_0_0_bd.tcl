...
proc create_root_design { parentCell } {
  ...
  set probe32 [ create_bd_port -dir I -from 31 -to 0 probe32 ]
  set probe33 [ create_bd_port -dir I -from 31 -to 0 probe33 ]
  set probe34 [ create_bd_port -dir I -from 31 -to 0 probe34 ]
  set probe35 [ create_bd_port -dir I -from 3 -to 0 probe35 ]
  set probe36 [ create_bd_port -dir I -from 1 -to 0 probe36 ]
  set probe37 [ create_bd_port -dir I -from 1 -to 0 probe37 ]
  set probe38 [ create_bd_port -dir I -from 1 -to 0 probe38 ]
  set probe39 [ create_bd_port -dir I -from 1 -to 0 probe39 ]
  set probe40 [ create_bd_port -dir I -from 1 -to 0 probe40 ]
  set probe41 [ create_bd_port -dir I -from 1 -to 0 probe41 ]
  set probe42 [ create_bd_port -dir I -from 1 -to 0 probe42 ]
  set probe43 [ create_bd_port -dir I -from 1 -to 0 probe43 ]
  ...
  set probe49 [ create_bd_port -dir I -from 31 -to 0 probe49 ]
  ...
  set probe56 [ create_bd_port -dir I -from 31 -to 0 probe56 ]
  set probe57 [ create_bd_port -dir I -from 0 -to 0 probe57 ]
  set probe58 [ create_bd_port -dir I -from 0 -to 0 probe58 ]
  set probe59 [ create_bd_port -dir I -from 0 -to 0 probe59 ]
