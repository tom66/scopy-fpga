...
(
	...
	output dbg_adc_1a_hi_0123a,
	output dbg_adc_1a_lo_0123a,
	output dbg_adc_1b_hi_0123a,
	output dbg_adc_1b_lo_0123a,
	output dbg_adc_2a_hi_0123a,
	output dbg_adc_2a_lo_0123a,
	output dbg_adc_2b_hi_0123a,
	output dbg_adc_2b_lo_0123a,
	
	output dbg_adc_1a_hi_4567a,
	output dbg_adc_1a_lo_4567a,
	output dbg_adc_1b_hi_4567a,
	output dbg_adc_1b_lo_4567a,
	output dbg_adc_2a_hi_4567a,
	output dbg_adc_2a_lo_4567a,
	output dbg_adc_2b_hi_4567a,
	output dbg_adc_2b_lo_4567a,
...
adc_trigger_core adc_trigger_core_0123a (
    ...
    .dbg_adc_1a_hi_x(dbg_adc_1a_hi_0123a),
    .dbg_adc_1a_lo_x(dbg_adc_1a_lo_0123a),
    .dbg_adc_1b_hi_x(dbg_adc_1b_hi_0123a),
    .dbg_adc_1b_lo_x(dbg_adc_1b_lo_0123a),
    .dbg_adc_2a_hi_x(dbg_adc_2a_hi_0123a),
    .dbg_adc_2a_lo_x(dbg_adc_2a_lo_0123a),
    .dbg_adc_2b_hi_x(dbg_adc_2b_hi_0123a),
    .dbg_adc_2b_lo_x(dbg_adc_2b_lo_0123a)
);
...
adc_trigger_core adc_trigger_core_4567a (
    ...
    .dbg_adc_1a_hi_x(dbg_adc_1a_hi_4567a),
    .dbg_adc_1a_lo_x(dbg_adc_1a_lo_4567a),
    .dbg_adc_1b_hi_x(dbg_adc_1b_hi_4567a),
    .dbg_adc_1b_lo_x(dbg_adc_1b_lo_4567a),
    .dbg_adc_2a_hi_x(dbg_adc_2a_hi_4567a),
    .dbg_adc_2a_lo_x(dbg_adc_2a_lo_4567a),
    .dbg_adc_2b_hi_x(dbg_adc_2b_hi_4567a),
    .dbg_adc_2b_lo_x(dbg_adc_2b_lo_4567a)
);
...
// 
// Overall summing logic.  Force trigger or always trigger force the
// trigger state.  The state of the 3-bit output word code is undefined and
// should be ignored in these cases. (Using it produces no useful effect.)
// 
assign trigger_out = trig_force_out | trig_always_out | trig_edge_out;
assign trigger_sub_word = trig_edge_out_word;
