...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net CSI_END_FRAME_1 [get_bd_ports CSI_END_FRAME] [get_bd_pins csi_gearbox_dma_0/csi_end_frame] [get_bd_pins system_ila_0/probe17]
  connect_bd_net -net CSI_SLEEP_1 [get_bd_ports CSI_SLEEP] [get_bd_pins csi_gearbox_dma_0/csi_sleep] [get_bd_pins system_ila_0/probe20]
  connect_bd_net -net CSI_START_FRAME_1 [get_bd_ports CSI_START_FRAME] [get_bd_pins csi_gearbox_dma_0/csi_start_frame] [get_bd_pins system_ila_0/probe18]
  connect_bd_net -net CSI_START_LINES_1 [get_bd_ports CSI_START_LINES] [get_bd_pins csi_gearbox_dma_0/csi_start_lines] [get_bd_pins system_ila_0/probe19]
  connect_bd_net -net CSI_STOP_1 [get_bd_ports CSI_STOP] [get_bd_pins csi_gearbox_dma_0/csi_stop] [get_bd_pins system_ila_0/probe16]
  ...
  connect_bd_net -net FabCfg_NextGen_0_R_csi_control_flags [get_bd_pins FabCfg_NextGen_0/R_csi_control_flags] [get_bd_pins csi_gearbox_dma_0/R_csi_control_flags] [get_bd_pins system_ila_0/probe25]
  connect_bd_net -net FabCfg_NextGen_0_R_csi_data_type [get_bd_pins FabCfg_NextGen_0/R_csi_data_type] [get_bd_pins csi_gearbox_dma_0/R_csi_data_type] [get_bd_pins system_ila_0/probe23]
  connect_bd_net -net FabCfg_NextGen_0_R_csi_line_byte_count [get_bd_pins FabCfg_NextGen_0/R_csi_line_byte_count] [get_bd_pins csi_gearbox_dma_0/R_csi_line_byte_count] [get_bd_pins system_ila_0/probe22]
  connect_bd_net -net FabCfg_NextGen_0_R_csi_line_count [get_bd_pins FabCfg_NextGen_0/R_csi_line_count] [get_bd_pins csi_gearbox_dma_0/R_csi_line_count] [get_bd_pins system_ila_0/probe21]
  ...
  connect_bd_net -net Net [get_bd_pins csi_gearbox_dma_0/s00_axis_tdata] [get_bd_pins mipi_dma/m_axis_mm2s_tdata] [get_bd_pins system_ila_0/probe24]
  connect_bd_net -net Net1 [get_bd_pins csi_gearbox_dma_0/s00_axis_tvalid] [get_bd_pins mipi_dma/m_axis_mm2s_tvalid] [get_bd_pins system_ila_0/probe26]
  ...
  connect_bd_net -net csi_gearbox_dma_0_csi_ctrl_state_dbg [get_bd_pins csi_gearbox_dma_0/csi_ctrl_state_dbg] [get_bd_pins system_ila_0/probe0]
  ...
  connect_bd_net -net csi_gearbox_dma_0_csi_debug_data_mux_out [get_bd_pins csi_gearbox_dma_0/csi_debug_data_mux_out] [get_bd_pins system_ila_0/probe11]
  connect_bd_net -net csi_gearbox_dma_0_csi_debug_fifo_read_valid [get_bd_pins csi_gearbox_dma_0/csi_debug_fifo_read_valid] [get_bd_pins system_ila_0/probe13]
  connect_bd_net -net csi_gearbox_dma_0_csi_debug_fifo_space_available [get_bd_pins csi_gearbox_dma_0/csi_debug_fifo_space_available] [get_bd_pins system_ila_0/probe14]
  connect_bd_net -net csi_gearbox_dma_0_csi_debug_mipi_read_req [get_bd_pins csi_gearbox_dma_0/csi_debug_mipi_read_req] [get_bd_pins system_ila_0/probe12]
  ...
  connect_bd_net -net csi_gearbox_dma_0_csi_debug_state_timer [get_bd_pins csi_gearbox_dma_0/csi_debug_state_timer] [get_bd_pins system_ila_0/probe8]
  connect_bd_net -net csi_gearbox_dma_0_csi_debug_state_timer2 [get_bd_pins csi_gearbox_dma_0/csi_debug_state_timer2] [get_bd_pins system_ila_0/probe9]
  connect_bd_net -net csi_gearbox_dma_0_csi_debug_state_timer_rst [get_bd_pins csi_gearbox_dma_0/csi_debug_state_timer_rst] [get_bd_pins system_ila_0/probe10]
  connect_bd_net -net csi_gearbox_dma_0_csi_debug_tx_size [get_bd_pins csi_gearbox_dma_0/csi_debug_tx_size] [get_bd_pins system_ila_0/probe6]
  ...
  connect_bd_net -net csi_gearbox_dma_0_csi_mipi_busy_dbg [get_bd_pins csi_gearbox_dma_0/csi_mipi_busy_dbg] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net csi_gearbox_dma_0_csi_mipi_done_dbg [get_bd_pins csi_gearbox_dma_0/csi_mipi_done_dbg] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net csi_gearbox_dma_0_csi_mipi_init_idle_dbg [get_bd_pins csi_gearbox_dma_0/csi_mipi_init_idle_dbg] [get_bd_pins system_ila_0/probe5]
  connect_bd_net -net csi_gearbox_dma_0_csi_mipi_init_long_dbg [get_bd_pins csi_gearbox_dma_0/csi_mipi_init_long_dbg] [get_bd_pins system_ila_0/probe4]
  connect_bd_net -net csi_gearbox_dma_0_csi_mipi_init_short_dbg [get_bd_pins csi_gearbox_dma_0/csi_mipi_init_short_dbg] [get_bd_pins system_ila_0/probe3]
  connect_bd_net -net csi_gearbox_dma_0_dbg_fifo_data_ct [get_bd_pins csi_gearbox_dma_0/dbg_fifo_data_ct] [get_bd_pins system_ila_0/probe15]
  connect_bd_net -net csi_gearbox_dma_0_dbg_ref_clk [get_bd_pins csi_gearbox_dma_0/dbg_ref_clk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net csi_gearbox_dma_0_s00_axis_tready [get_bd_pins csi_gearbox_dma_0/s00_axis_tready] [get_bd_pins mipi_dma/m_axis_mm2s_tready] [get_bd_pins system_ila_0/probe27]
  ...
  assign_bd_address -offset 0x83C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ps/Data] [get_bd_addr_segs FabCfg_NextGen_0/S00_AXI/S00_AXI_reg] -force
