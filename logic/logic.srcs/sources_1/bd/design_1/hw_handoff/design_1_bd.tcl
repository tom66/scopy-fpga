...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net ADC_DATA_CLK_1 [get_bd_ports ADC_DATA_CLK] [get_bd_pins adc_axi_streamer/m00_axis_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk]
