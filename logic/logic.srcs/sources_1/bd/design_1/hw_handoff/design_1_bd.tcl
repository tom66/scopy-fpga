...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net ACQ_TRIG_MASK1_1 [get_bd_ports ACQ_DEPTH_MUX] [get_bd_pins adc_axi_streamer/acq_depth_mux] [get_bd_pins ila_0/probe7]
  ...
  connect_bd_net -net adc_axi_streamer_adc_fifo_full [get_bd_pins adc_axi_streamer/adc_fifo_full] [get_bd_pins ila_0/probe15]
