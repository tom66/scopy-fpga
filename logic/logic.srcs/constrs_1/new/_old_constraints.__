...
set_property PACKAGE_PIN A20 [get_ports csi_d0_p]
set_property LOC A20 [get_ports csi_d0_p]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports csi_d0_n]
set_property PACKAGE_PIN B19 [get_ports csi_d0_n]
set_property LOC B19 [get_ports csi_d0_n]
...
set_property PACKAGE_PIN B20 [get_ports csi_d1_p]
set_property LOC B20 [get_ports csi_d1_p]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports csi_d1_n]
set_property PACKAGE_PIN C20 [get_ports csi_d1_n]
set_property LOC C20 [get_ports csi_d1_n]
...
set_property PACKAGE_PIN G20 [get_ports csi_clk_p]
set_property LOC G20 [get_ports csi_clk_p]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports csi_clk_n]
set_property PACKAGE_PIN G19 [get_ports csi_clk_n]
set_property LOC G19 [get_ports csi_clk_n]
...
set_property PACKAGE_PIN G19 [get_ports csi_lpclk_n]
set_property IOSTANDARD LVCMOS18 [get_ports csi_lpclk_p]
set_property PACKAGE_PIN G20 [get_ports csi_lpclk_p]
