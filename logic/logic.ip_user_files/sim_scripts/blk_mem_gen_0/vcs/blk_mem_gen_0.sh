...
#
# Generated by Vivado on Mon Dec 02 20:26:02 +0000 2019
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_2 $vlogan_opts +v2k +incdir+"G:/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"G:/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
    "$ref_dir/../../../../logic.srcs/sources_1/ip/blk_mem_gen_0/sim/blk_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
