...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f60c.protoinst" -protoinst "protoinst_files/bd_6e42.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
