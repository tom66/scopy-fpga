...
#
# Generated by export_simulation on Fri Jan 17 15:45:13 +0000 2020
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_1_idelay_refclk.sh' script.

./clk_wiz_1_idelay_refclk.sh -reset_run
...
./clk_wiz_1_idelay_refclk.sh -noclean_files

For more information on the script, please type './clk_wiz_1_idelay_refclk.sh -help'.
