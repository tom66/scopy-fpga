...
module mipi_csi(
    ...
    output [1:0] debug_lp_state,
    output [2:0] debug_lpclk_state,
...
// Debug outputs for above state registers
assign debug_lp_state = csi_lp_state;
assign debug_lpclk_state = csi_lpclk_state;
