...
proc create_root_design { parentCell } {
  ...
  set probe10 [ create_bd_port -dir I -from 2 -to 0 probe10 ]
  set probe11 [ create_bd_port -dir I -from 2 -to 0 probe11 ]
  ...
  set probe17 [ create_bd_port -dir I -from 15 -to 0 probe17 ]
