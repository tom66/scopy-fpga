...
HD_PWD='C:/Users/Tom/Documents/Projects/Scopy_MVP_Platform/scopy-fpga/logic/logic.runs/design_1_axi_dma_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_dma_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_dma_0.tcl
