...
HD_PWD='C:/Users/Tom/Documents/Projects/Scopy_MVP_Platform/scopy-fpga/logic/logic.runs/clk_wiz_1_idelay_refclk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_1_idelay_refclk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_1_idelay_refclk.tcl
