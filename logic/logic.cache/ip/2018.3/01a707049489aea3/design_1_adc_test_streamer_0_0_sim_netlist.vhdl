...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_adc_test_streamer_v2_0_M00_AXIS is
  ...
  signal stream_data_out0 : STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^m00_axis_tdata\ : STD_LOGIC_VECTOR ( 6 to 6 );
...
begin
  ...
  m00_axis_tdata(6) <= \^m00_axis_tdata\(6);
  m00_axis_tdata(5) <= \^m00_axis_tdata\(6);
  m00_axis_tdata(4) <= \<const0>\;
  m00_axis_tdata(3) <= \^m00_axis_tdata\(6);
  m00_axis_tdata(2) <= \^m00_axis_tdata\(6);
  m00_axis_tdata(1) <= \^m00_axis_tdata\(6);
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_adc_test_streamer_v2_0
     port map (
      m00_axis_aclk => m00_axis_aclk,
      m00_axis_aresetn => m00_axis_aresetn,
      m00_axis_tdata(0) => \^m00_axis_tdata\(6),
      m00_axis_tlast => m00_axis_tlast,
      m00_axis_tready => m00_axis_tready,
      m00_axis_tvalid => m00_axis_tvalid
    );
