...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -g -Wall -Wextra -DFSBL_DEBUG_INFO
END


BEGIN DRIVER
 PARAMETER DRIVER_NAME = FabCfg_NextGen
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = FabCfg_NextGen_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.10
 PARAMETER HW_INSTANCE = adc_dma
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.10
 PARAMETER HW_INSTANCE = mipi_dma
END
