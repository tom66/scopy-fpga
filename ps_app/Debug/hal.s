...
.LFE7:
	...
	.comm	g_hal,344,8
	.align	2
	.global	irq_xscutimer
	.syntax unified
	.arm
	.fpu vfpv3
	.type	irq_xscutimer, %function
irq_xscutimer:
.LFB13:
	.file 2 "../src/hal.c"
	.loc 2 46 0
	...
	bne	.L6
	.loc 2 50 0
	movw	r3, #:lower16:g_hal
	movt	r3, #:upper16:g_hal
	ldr	r3, [r3, #72]
	add	r2, r3, #1
	movw	r3, #:lower16:g_hal
	movt	r3, #:upper16:g_hal
...
.L6:
	...
	.cfi_endproc
.LFE13:
	.size	irq_xscutimer, .-irq_xscutimer
	.section	.rodata
	.align	2
.LC0:
	.ascii	"\015\012\015\012\033[2J\033[0m\015\012\000"
	.align	2
.LC1:
	.ascii	"v0.0.1-alpha\000"
	.align	2
.LC2:
	.ascii	"ps_app: Zynq application for YAOS Oscilloscope Proj"
	.ascii	"ect (%s)\000"
	.align	2
.LC3:
	.ascii	"20:43:38\000"
...
.LC6:
	...
	.align	2
.LC7:
	.ascii	"Application (C) 2020 Tomato Engineering Ltd.\000"
	.align	2
.LC8:
	.ascii	"Parts       (C) 2005 - 2015 Xilinx, Inc.\000"
	.align	2
.LC9:
	.ascii	"Application is licenced under the MIT Licence\000"
	.align	2
.LC10:
	.ascii	"For information see LICENCE in the Git repository\000"
	.align	2
.LC11:
	.ascii	"XScuGic: configuration lookup returns NULL\000"
	.align	2
.LC12:
	.ascii	"XScuGic: configuration init returned error %d\000"
	.align	2
.LC13:
	.ascii	"XScuGic: interrupt controller ready\000"
	.align	2
.LC14:
	.ascii	"XScuTimer: returned error code: %d, unable to start"
	.ascii	"\000"
	.align	2
.LC15:
	.ascii	"XScuTimer: self test failed with error %d\000"
	.align	2
.LC16:
	.ascii	"XScuTimer: ready\000"
	.align	2
.LC17:
	.ascii	"XScuTimer: unable to connect interrupt handler: err"
	.ascii	"or code %d\000"
	.align	2
.LC18:
	.ascii	"XScuTimer: config: %3.3f MHz, 1 tick = %.3f us\000"
	.align	2
.LC19:
	.ascii	"BogoDelay: Test 100 ms\000"
	.align	2
.LC20:
	.ascii	"XGpioPs: returned error code: %d, unable to start\000"
	.align	2
.LC21:
	.ascii	"XGpioPs: ready\000"
	.text
	.align	2
	.global	hal_init
	.syntax unified
...
.LFB14:
	...
	bl	init_platform
	.loc 2 66 0
	movw	r0, #:lower16:d_xilinx_assert
	movt	r0, #:upper16:d_xilinx_assert
	bl	Xil_AssertSetCallback
	.loc 2 69 0
	movw	r1, #:lower16:.LC0
	movt	r1, #:upper16:.LC0
	mov	r0, #0
...
.L8:
	...
	ldr	r3, [r3, #4]
	mov	r2, r3
	movw	r0, #:lower16:g_hal
	movt	r0, #:upper16:g_hal
...
.L9:
	...
	.loc 2 97 0
	movw	r2, #:lower16:g_hal
	movt	r2, #:upper16:g_hal
...
.L11:
	...
	.loc 2 120 0
	ldr	r3, .L14
	movw	r2, #:lower16:irq_xscutimer
	movt	r2, #:upper16:irq_xscutimer
	mov	r1, #29
	movw	r0, #:lower16:g_hal
	movt	r0, #:upper16:g_hal
	bl	XScuGic_Connect
...
.LFE14:
	...
	.align	2
.LC22:
	.ascii	"BogoDelay: starting calibration\000"
	.global	__aeabi_ul2d
	.align	2
.LC23:
	.ascii	"BogoDelay: calibrated: 1us = %2.3f cycles (total ti"
	.ascii	"me %2.1f us) (%2.2f BogoMIPS)\000"
	.text
	.align	2
	.global	bogo_calibrate
	.syntax unified
	.arm
	.fpu vfpv3
	.type	bogo_calibrate, %function
bogo_calibrate:
.LFB15:
	.loc 2 189 0
	.cfi_startproc
...
.L19:
	...
	.cfi_endproc
.LFE15:
	.size	bogo_calibrate, .-bogo_calibrate
...
.L22:
	...
	.cfi_endproc
.LFE16:
	.size	bogo_delay, .-bogo_delay
	.align	2
	.global	gpio_led_write
	.syntax unified
	.arm
	.fpu vfpv3
	.type	gpio_led_write, %function
gpio_led_write:
.LFB17:
	.loc 2 240 0
	.cfi_startproc
...
.L29:
	...
	.cfi_endproc
.LFE17:
	.size	gpio_led_write, .-gpio_led_write
	.section	.rodata
	.align	2
.LC24:
	.ascii	"[--] \000"
	.align	2
.LC25:
	.ascii	"\033[0;97m[ii] \000"
	.align	2
.LC26:
	.ascii	"\033[30;103m[WW]\033[0;93m \000"
	.align	2
.LC27:
	.ascii	"\033[97;41m[EE]\033[0;91m \000"
...
.LC29:
	...
	.arm
	.fpu vfpv3
	.type	d_printf, %function
d_printf:
.LFB18:
	.loc 2 266 0
	.cfi_startproc
	@ args = 4, pretend = 12, frame = 4144
...
.L45:
	...
	.cfi_endproc
.LFE18:
	.size	d_printf, .-d_printf
	.align	2
	.global	d_read_global_timer
	.syntax unified
	.arm
	.fpu vfpv3
	.type	d_read_global_timer, %function
d_read_global_timer:
.LFB19:
	.loc 2 332 0
	.cfi_startproc
...
.L51:
	...
	.cfi_endproc
.LFE19:
	.size	d_read_global_timer, .-d_read_global_timer
	.section	.rodata
	.align	2
.LC30:
	.ascii	"../src/hal.c\000"
	.align	2
.LC31:
	.ascii	"index < NUM_DEBUG_TIMERS\000"
	.align	2
.LC32:
	.ascii	"assertion failed: `%s' (file %s, line %d)\000"
	.text
	.align	2
	.global	d_start_timing
	.syntax unified
	.arm
	.fpu vfpv3
	.type	d_start_timing, %function
d_start_timing:
.LFB20:
	.loc 2 370 0
	.cfi_startproc
...
.L53:
	...
	.cfi_endproc
.LFE20:
	.size	d_start_timing, .-d_start_timing
	.align	2
	.global	d_stop_timing
	.syntax unified
	.arm
	.fpu vfpv3
	.type	d_stop_timing, %function
d_stop_timing:
.LFB21:
	.loc 2 389 0
	.cfi_startproc
...
.L55:
	...
	.cfi_endproc
.LFE21:
	.size	d_stop_timing, .-d_stop_timing
	.align	2
	.global	d_read_timing
	.syntax unified
	.arm
	.fpu vfpv3
	.type	d_read_timing, %function
d_read_timing:
.LFB22:
	.loc 2 410 0
	.cfi_startproc
...
.L57:
	...
	.cfi_endproc
.LFE22:
	.size	d_read_timing, .-d_read_timing
	.global	__aeabi_l2d
	.align	2
	.global	d_read_timing_us
	.syntax unified
	.arm
	.fpu vfpv3
	.type	d_read_timing_us, %function
d_read_timing_us:
.LFB23:
	.loc 2 423 0
	.cfi_startproc
...
.L62:
	...
	.cfi_endproc
.LFE23:
	.size	d_read_timing_us, .-d_read_timing_us
	.section	.rodata
	.align	2
.LC33:
	.ascii	"%s [~%llu CPU cycles (~%4.1f us)]\000"
	.text
	.align	2
	.global	d_dump_timing
	.syntax unified
	.arm
	.fpu vfpv3
	.type	d_dump_timing, %function
d_dump_timing:
.LFB24:
	.loc 2 435 0
	.cfi_startproc
	...
	.cfi_endproc
.LFE24:
	.size	d_dump_timing, .-d_dump_timing
	.section	.rodata
	.align	2
.LC34:
	.ascii	"Assert failed at line %d of file `%s'\015\012\000"
	.text
	.align	2
	.global	d_xilinx_assert
	.syntax unified
	.arm
	.fpu vfpv3
	.type	d_xilinx_assert, %function
d_xilinx_assert:
.LFB25:
	.loc 2 445 0
	.cfi_startproc
	...
	.cfi_endproc
.LFE25:
	.size	d_xilinx_assert, .-d_xilinx_assert
.Letext0:
	...
	.file 15 "g:\\xilinx\\sdk\\2018.3\\gnu\\aarch32\\nt\\gcc-arm-none-eabi\\arm-none-eabi\\libc\\usr\\include\\stdlib.h"
	.file 16 "../../ps_app_bsp/ps7_cortexa9_0/include/xil_exception.h"
	.file 17 "../../ps_app_bsp/ps7_cortexa9_0/include/xscugic.h"
	.file 18 "../../ps_app_bsp/ps7_cortexa9_0/include/xscutimer.h"
	.file 19 "../src/hal.h"
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 42 "../../ps_app_bsp/ps7_cortexa9_0/include/xil_printf.h"
	.byte	0x3
	.uleb128 0x19
	.uleb128 0x2a
	.byte	0x5
	...
	.byte	0x4
	.file 45 "../../ps_app_bsp/ps7_cortexa9_0/include/xparameters.h"
	.byte	0x3
	.uleb128 0xc
	.uleb128 0x2d
	.byte	0x7
	.4byte	.Ldebug_macro32
	.file 46 "../../ps_app_bsp/ps7_cortexa9_0/include/xparameters_ps.h"
	.byte	0x3
	.uleb128 0x13
	.uleb128 0x2e
	.byte	0x7
	...
	.byte	0x4
	.file 47 "../../ps_app_bsp/ps7_cortexa9_0/include/bspconfig.h"
	.byte	0x3
	.uleb128 0xd
	.uleb128 0x2f
	.byte	0x7
	...
	.uleb128 0xc
	.byte	0x4
	.file 48 "../../ps_app_bsp/ps7_cortexa9_0/include/xil_cache.h"
	.byte	0x3
	.uleb128 0x1b
	.uleb128 0x30
	.byte	0x7
	...
	.uleb128 0x2a
	.byte	0x4
	.file 49 "../../ps_app_bsp/ps7_cortexa9_0/include/xpseudo_asm.h"
	.byte	0x3
	.uleb128 0x42
	.uleb128 0x31
	.byte	0x5
	.uleb128 0x3c
	.4byte	.LASF1494
	.file 50 "../../ps_app_bsp/ps7_cortexa9_0/include/xreg_cortexa9.h"
	.byte	0x3
	.uleb128 0x3e
	.uleb128 0x32
	.byte	0x7
	...
	.byte	0x4
	.file 51 "../../ps_app_bsp/ps7_cortexa9_0/include/xpseudo_asm_gcc.h"
	.byte	0x3
	.uleb128 0x40
	.uleb128 0x33
	.byte	0x7
	...
	.byte	0x4
	.file 52 "../../ps_app_bsp/ps7_cortexa9_0/include/xil_testmem.h"
	.byte	0x3
	.uleb128 0x1d
	.uleb128 0x34
	.byte	0x7
	...
	.byte	0x4
	.file 53 "../../ps_app_bsp/ps7_cortexa9_0/include/xuartps_hw.h"
	.byte	0x3
	.uleb128 0x1e
	.uleb128 0x35
	.byte	0x5
	...
	.uleb128 0x6f
	.4byte	.LASF1918
	.file 54 "../../ps_app_bsp/ps7_cortexa9_0/include/xstatus.h"
	.byte	0x3
	.uleb128 0x77
	.uleb128 0x36
	.byte	0x7
	...
	.byte	0x4
	.file 55 "../../ps_app_bsp/ps7_cortexa9_0/include/xgpiops_hw.h"
	.byte	0x3
	.uleb128 0x78
	.uleb128 0x37
	.byte	0x7
	...
	.byte	0x4
	.file 56 "../../ps_app_bsp/ps7_cortexa9_0/include/xplatform_info.h"
	.byte	0x3
	.uleb128 0x79
	.uleb128 0x38
	.byte	0x7
	...
	.byte	0x4
	.file 57 "../../ps_app_bsp/ps7_cortexa9_0/include/xaxidma.h"
	.byte	0x3
	.uleb128 0x20
	.uleb128 0x39
	.byte	0x5
	.uleb128 0x1e1
	.4byte	.LASF2124
	.file 58 "../../ps_app_bsp/ps7_cortexa9_0/include/xaxidma_bdring.h"
	.byte	0x3
	.uleb128 0x1e8
	.uleb128 0x3a
	.byte	0x5
	.uleb128 0x4a
	.4byte	.LASF2125
	.file 59 "../../ps_app_bsp/ps7_cortexa9_0/include/xaxidma_bd.h"
	.byte	0x3
	.uleb128 0x53
	.uleb128 0x3b
	.byte	0x5
	.uleb128 0x6a
	.4byte	.LASF2126
	.file 60 "../../ps_app_bsp/ps7_cortexa9_0/include/xaxidma_hw.h"
	.byte	0x3
	.uleb128 0x72
	.uleb128 0x3c
	.byte	0x7
	...
	.byte	0x4
	.file 61 "../../ps_app_bsp/ps7_cortexa9_0/include/xdebug.h"
	.byte	0x3
	.uleb128 0x74
	.uleb128 0x3d
	.byte	0x7
	...
	.uleb128 0xb9
	.4byte	.LASF2307
	.file 64 "../../ps_app_bsp/ps7_cortexa9_0/include/xscugic_hw.h"
	.byte	0x3
	.uleb128 0xc4
	.uleb128 0x40
	.byte	0x5
	...
	.uleb128 0x6c
	.4byte	.LASF2433
	.file 65 "../../ps_app_bsp/ps7_cortexa9_0/include/xscutimer_hw.h"
	.byte	0x3
	.uleb128 0x71
	.uleb128 0x41
	.byte	0x7
...
.Ldebug_macro59:
	...
	.4byte	.LASF2464
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.hal.h.37.8648a365aee9bd9011e9c21f7ab3e05c,comdat
.Ldebug_macro60:
	.2byte	0x4
	.byte	0
	.byte	0x5
	...
	.4byte	.LASF2487
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.fabric_config.h.34.fcef45c804536abffbb0a9c6d9aaf242,comdat
.Ldebug_macro61:
	.2byte	0x4
	.byte	0
	.byte	0x5
	...
	.4byte	.LASF2500
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.version_tag.h.9.d921c15beb936211d7833cfdaf031326,comdat
.Ldebug_macro62:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF2496:
	.ascii	"FAB_CFG_ACQ_DEMUX_MODE 0x006\000"
.LASF1858:
...
.LASF2690:
	.ascii	"d_read_timing_us\000"
.LASF2488:
	.ascii	"SRC_FABRIC_CONFIG_H_ \000"
.LASF1379:
...
.LASF2493:
	.ascii	"FAB_CFG_VERSION 0x003\000"
.LASF2248:
...
.LASF2494:
	.ascii	"FAB_CFG_ACQ_SIZE 0x004\000"
.LASF2136:
...
.LASF2478:
	.ascii	"XSCUTIMER_LOAD_VALUE_LU (0xffffffffLU)\000"
.LASF619:
...
.LASF2492:
	.ascii	"FAB_CFG_MAGIC1 0x002\000"
.LASF2123:
...
.LASF2468:
	.ascii	"D_RAW 0\000"
.LASF2480:
	.ascii	"XSCUTIMER_OVERFLOW_TIME_US ((XSCUTIMER_OVERFLOW_TIM"
	.ascii	"E) * 1e6)\000"
.LASF2124:
...
.LASF2490:
	.ascii	"FAB_CFG_DUMMY1 0x000\000"
.LASF765:
...
.LASF2485:
	.ascii	"D_ASSERT(expr) { if(!(expr)) { d_printf(D_ERROR, \""
	.ascii	"assertion failed: `%s' (file %s, line %d)\", #expr,"
	.ascii	" __FILE__, __LINE__); } }\000"
.LASF339:
...
.LASF542:
	.ascii	"_SIZE_T_ \000"
.LASF2474:
	.ascii	"XSCUTIMER_TICKS_TO_S (2.0f / XPAR_PS7_CORTEXA9_0_CP"
	.ascii	"U_CLK_FREQ_HZ)\000"
.LASF1722:
...
.LASF2667:
	.ascii	"XScuGic\000"
.LASF2475:
	.ascii	"XSCUTIMER_TICKS_TO_US (XSCUTIMER_TICKS_TO_S * 1e6)\000"
.LASF1267:
...
.LASF2491:
	.ascii	"FAB_CFG_DUMMY2 0x001\000"
.LASF559:
...
.LASF2476:
	.ascii	"XSCUTIMER_TICKS_TO_CPUCYC 2\000"
.LASF582:
...
.LASF2481:
	.ascii	"XSCUTIMER_NEAR_OVERFLOW (XSCUTIMER_LOAD_VALUE - 0xf"
	.ascii	"f)\000"
.LASF1990:
...
.LASF2473:
	.ascii	"XSCUTIMER_CLOCK (XPAR_PS7_CORTEXA9_0_CPU_CLK_FREQ_H"
	.ascii	"Z / 2.0f)\000"
.LASF38:
...
.LASF2499:
	.ascii	"FAB_CFG_EMIO_COMMIT 3\000"
.LASF723:
	.ascii	"unsigned\000"
.LASF2408:
...
.LASF2502:
	.ascii	"PS_APP_VERSION_TAG \"v0.0.1-alpha\"\000"
.LASF1344:
...
.LASF2295:
	...
	.ascii	"LL_MASK)\000"
.LASF2489:
	.ascii	"AXI_CFG_BRAM_BASE_ADDRESS XPAR_AXI_BRAM_CTRL_0_S_AX"
	.ascii	"I_BASEADDR\000"
.LASF824:
...
.LASF2486:
	.ascii	"BOGOCAL_ITERAMT 100000\000"
.LASF1410:
...
.LASF2479:
	.ascii	"XSCUTIMER_OVERFLOW_TIME (XSCUTIMER_LOAD_VALUE_LU / "
	.ascii	"XSCUTIMER_CLOCK)\000"
.LASF2152:
...
.LASF2477:
	.ascii	"XSCUTIMER_LOAD_VALUE (0xffffffff)\000"
.LASF1548:
...
.LASF2484:
	.ascii	"GPIO_PS_LED_1_PIN 37\000"
.LASF245:
...
.LASF2495:
	.ascii	"FAB_CFG_ACQ_TRIGGER_PTR 0x005\000"
.LASF1765:
...
.LASF2498:
	.ascii	"FAB_CFG_ADDR_MASK 0xfff\000"
.LASF1745:
...
.LASF2497:
	.ascii	"FAB_CFG_GPIO_TEST 0x007\000"
.LASF2670:
	.ascii	"XScuTimer\000"
.LASF2102:
...
.LASF2688:
	.ascii	"d_dump_timing\000"
.LASF2694:
	.ascii	"d_start_timing\000"
.LASF859:
	.ascii	"_IONBF 2\000"
.LASF2004:
