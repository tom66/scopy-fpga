...
Intc:
	.space	12
	.size	Intc, 12
	.comm	rx_buffer,8388608,1048576
	.comm	tx_buffer,8388608,1048576
...
.LFB15:
	...
	beq	.L9
	.loc 2 156 0
	movw	r3, #:lower16:err_flag
	movt	r3, #:upper16:err_flag
	mov	r2, #1
	str	r2, [r3]
.L9:
	.loc 2 195 0
...
.LFB17:
	...
	.cfi_endproc
.LFE17:
	.size	start_timing, .-start_timing
	.align	2
	.global	stop_timing
	.syntax unified
	.arm
...
.LC9:
	...
	.align	2
.LC10:
	.ascii	"Reset AXIDMA\000"
	.align	2
.LC11:
	.ascii	"Setup interrupts\000"
	.align	2
.LC12:
...
.LC14:
	...
	.align	2
.LC15:
	.ascii	"\033[91mERROR:\033[0m err_flag in interrupt was set"
	.ascii	"\015\012\000"
	.align	2
.LC16:
	...
	.align	2
.LC17:
	.ascii	"this_value: 0x%08x, last_value: 0x%08x, delta=%d, e"
	.ascii	"rror_at_word=%d, since_last_error=%d\015\012\000"
	.align	2
.LC18:
	.ascii	"this_value: 0x%08x, last_value: 0x%08x, delta=%d\015"
	.ascii	"\012\000"
	.align	2
.LC19:
...
.LASF2443:
	.ascii	"TIMER_TICKS_TO_US (TIMER_TICKS_TO_S * 1e6)\000"
.LASF687:
	.ascii	"_T_WCHAR_ \000"
.LASF1743:
...
.LASF2442:
	.ascii	"TIMER_TICKS_TO_S (2.0f / XPAR_PS7_CORTEXA9_0_CPU_CL"
	.ascii	"K_FREQ_HZ)\000"
.LASF1209:
