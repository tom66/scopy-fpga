...
#define TRIG_CTRL_EDGEA_FALLING				0x01000000
#define TRIG_CTRL_EDGEA_RISING				0x02000000
#define TRIG_CTRL_EDGEA_BOTH				0x03000000
#define TRIG_CTRL_EDGEA_BITFIELD			0x03000000
#define TRIG_CTRL_EDGEB_NONE				0x00000000
#define TRIG_CTRL_EDGEB_FALLING				0x04000000
#define TRIG_CTRL_EDGEB_RISING				0x08000000
